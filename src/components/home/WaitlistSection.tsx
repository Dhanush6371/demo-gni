...
//     <div className="prose prose-xs mb-6 max-h-[60vh] overflow-y-auto">
//       <p className="text-xs">By joining our waitlist, you agree to the following terms:</p>
//       <ul className="list-disc pl-5  text-[9px]">
